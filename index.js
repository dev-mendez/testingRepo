...
//   if ((n % x === 0) & (n % y === 0)) r = true;
//   else r = false;
//   return r;
// }
// console.log(isDivisible(10, 2, 4));
...
//   let f = line.toString().length;
//   let res;
//   let final;
//   if (f % 2 == 0) {
//     let half = line.slice(0, f / 2);
//     let anotherHalf = line.slice(f / 2, f);
//     res = anotherHalf
//       .split('')
//       .reverse()
//       .join('');
//     final = half == res ? true : false;
//   } else {
//     let half = line.slice(0, (f - 1) / 2);
//     let anotherHalf = line.slice((f + 1) / 2, f);
//     res = anotherHalf
//       .split('')
//       .reverse()
//       .join('');
...
//     acum.push(stairs[i].reduce((a, b) => a + b));
//   }
//   return 20 * acum.reduce((a, b) => a + b); j/]
// }
